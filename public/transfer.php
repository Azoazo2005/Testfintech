...
<nav class="navbar navbar-pro sticky-top">
    <div class="container d-flex justify-content-between align-items-center">
        <a class="pro-brand" href="dashboard.php"><i class="bi bi-snow2 me-2"></i>FINTECH</a>
...
<div id="receiptOverlay" class="pro-overlay">
    <div class="pro-receipt-card animate-pro-fadein">
        <div class="text-center mb-4">
            <div class="pro-brand justify-content-center mb-2"><i class="bi bi-snow2 me-2"></i>FINTECH</div>
