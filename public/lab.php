...
<nav class="navbar-pro">
    <div class="container d-flex justify-content-between align-items-center">
        <a href="dashboard.php" class="pro-brand">
            <i class="bi bi-snow2 me-2"></i>FINTECH<span class="fw-normal text-pro-muted">_VULNERABLE</span>
        </a>
...
<footer class="footer mt-auto py-5 border-top border-pro">
    <div class="container text-center">
        <p class="text-pro-muted x-small">&copy; 2026 FINTECH_VULNERABLE SOLUTIONS. EDUCATION LAB.</p>
    </div>
</footer>
