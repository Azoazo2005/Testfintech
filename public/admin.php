...
<nav class="navbar navbar-pro sticky-top">
    <div class="container d-flex justify-content-between align-items-center">
        <a class="pro-brand" href="dashboard.php"><i class="bi bi-shield-lock-fill me-2"></i>FINTECH<span class="fw-normal text-pro-muted">_VULNERABLE</span></a>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-6">
            <div class="pro-card border-0 bg-pro-soft p-4">
                ...
                <p class="text-pro-muted small mb-0 mt-2">Flux monétaire global détecté sur les serveurs FINTECH_VULNERABLE.</p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="pro-card border-0 bg-pro-soft p-4">
